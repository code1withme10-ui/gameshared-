...
<body>
    ...
    <section class="hero-section">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                Welcome,<br>
                <span class="highlight"><?= htmlspecialchars($_SESSION['user']['name']) ?></span>
            </h1>
            
            <p class="hero-subtitle">
                Manage your child's admission applications and track their progress
            </p>
            
            <div class="hero-buttons">
                <a href="admission.php" class="btn btn-primary btn-large hero-btn-primary">
                    <i class="fas fa-plus"></i> 
                    <span>New Application</span>
                    <i class="fas fa-arrow-right"></i>
                </a>
                <a href="logout.php" class="btn btn-secondary btn-large hero-btn-secondary">
            ...
            <div class="hero-stats">
                <div class="stat-item">
                    <div class="stat-number"><?= count($parentApplications) ?></div>
