...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_SESSION['user']['role'] ?? '') === 'headmaster') {
    ...
    if ($title && $message) {
        ...
        header('Location: notice-board.php'); // Refresh
        exit;
    }
}
...
<div class="container" style="margin-top:50px;">
    ...
    <?php if ($_SESSION['user']['role'] === 'headmaster'): ?>
        ...
        <ul class="list-group">
            <?php foreach (array_reverse($notices) as $notice): ?>
                <li class="list-group-item">
                    ...
                    <small>Posted by: <?php echo htmlspecialchars($notice['posted_by']); ?> on <?php echo htmlspecialchars($notice['date']); ?></small>
                </li>
            <?php endforeach; ?>
        </ul>
    <?php else: ?>
