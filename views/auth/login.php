            ...
            <form id="loginForm" method="POST" action="/login" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <small style="display:block; margin-top:8px; color: #6c757d; font-size: 0.85rem;">
                        <i class="fas fa-shield-alt"></i> Security: Profile locks permanently after 3 failed attempts.
                    </small>
                </div>
...
document.getElementById('loginForm').addEventListener('submit', function() {
    ...
    if (loginAttempts >= maxAttempts) {
        // We let the form submit so the backend correctly handles the final lockout.
        setTimeout(() => {
            const loginBtn = document.getElementById('loginBtn');
            loginBtn.disabled = true;
