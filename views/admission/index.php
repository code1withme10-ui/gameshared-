    ...
    <div class="admission-container">
        <div class="admission-form-container">
            <div class="form-header">
                ...
                <?php if (defined('ADMISSION_CLOSING_DATE')): ?>
                <div class="alert alert-warning" style="margin-top: 20px; text-align: left; background: #fff3cd; color: #856404; border-left: 5px solid #ffeeba;">
                    <i class="fas fa-calendar-times"></i>
                    <strong>Important Notice:</strong> Admission applications will strictly close on <strong><?= date('F jS, Y', strtotime(ADMISSION_CLOSING_DATE)) ?></strong>.
                </div>
                <?php endif; ?>
            </div>
            ...
            <form id="admissionForm" method="POST" action="admission.php" class="admission-form" enctype="multipart/form-data">
                ...
                <fieldset class="form-section">
                    ...
                    <?php if (isset($_SESSION['user'])): ?>
                        <div class="alert alert-info">
                            ...
                            Your details have been automatically filled from your registration. You can review but cannot edit them here.
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="parentFullName" name="parentFullName" required
                               value="<?= htmlspecialchars(isset($_SESSION['user']) ? 
                                   trim(($_SESSION['user']['name'] ?? '') . ' ' . ($_SESSION['user']['surname'] ?? '')) : 
                                   ($old['parentFullName'] ?? '')) ?>"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="motherFirstName" name="motherFirstName"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'mother' ? ($_SESSION['user']['name'] ?? '') : ($old['motherFirstName'] ?? '')) ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="motherSurname">Surname</label>
                            <input type="text" id="motherSurname" name="motherSurname"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'mother' ? ($_SESSION['user']['surname'] ?? '') : ($old['motherSurname'] ?? '')) ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="motherIdNumber" name="motherIdNumber"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'mother' ? ($_SESSION['user']['id_number'] ?? '') : ($old['motherIdNumber'] ?? '')) ?>">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="fatherFirstName" name="fatherFirstName"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'father' ? ($_SESSION['user']['name'] ?? '') : ($old['fatherFirstName'] ?? '')) ?>">
                        </div>
                        
                        <div class="form-group">
                            <label for="fatherSurname">Surname</label>
                            <input type="text" id="fatherSurname" name="fatherSurname"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'father' ? ($_SESSION['user']['surname'] ?? '') : ($old['fatherSurname'] ?? '')) ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="fatherIdNumber" name="fatherIdNumber"
                                   value="<?= htmlspecialchars(isset($_SESSION['user']) && strtolower($_SESSION['user']['relationship'] ?? '') === 'father' ? ($_SESSION['user']['id_number'] ?? '') : ($old['fatherIdNumber'] ?? '')) ?>">
                        </div>
