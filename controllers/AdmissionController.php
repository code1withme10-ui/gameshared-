...
class AdmissionController extends BaseController {
    ...
    public function index() {
        ...
        if (defined('ADMISSION_CLOSING_DATE') && time() > strtotime(ADMISSION_CLOSING_DATE . ' 23:59:59')) {
            $this->setFlashMessage('error', 'Applications are currently closed. The closing date was ' . date('F jS, Y', strtotime(ADMISSION_CLOSING_DATE)) . '.');
            redirect('/');
            return;
        }
    ...
    public function submit() {
        // Check if applications are closed
        if (defined('ADMISSION_CLOSING_DATE') && time() > strtotime(ADMISSION_CLOSING_DATE . ' 23:59:59')) {
            $this->setFlashMessage('error', 'Applications are currently closed.');
            redirect('/');
            return;
        }
